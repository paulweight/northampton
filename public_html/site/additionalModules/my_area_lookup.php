...
<head>
	<title><?php print encodeHtml(METADATA_GENERIC_NAME); ?> - In my area</title>

	<?php include_once("../includes/stylesheets.php"); ?>
	<?php include_once("../includes/metadata.php"); ?>
	
	<meta name="Keywords" content="about,in,your,area<?php print encodeHtml(METADATA_GENERIC_COUNCIL_KEYWORDS); ?>" />
	<meta name="Description" content="<?php print encodeHtml(METADATA_GENERIC_NAME); ?> - In my area postcode searches." />

	<meta name="DC.title" lang="en" content="<?php print encodeHtml(METADATA_GENERIC_NAME); ?> - In my area" />
	<meta name="DC.description" lang="en" content="<?php print encodeHtml(METADATA_GENERIC_NAME); ?> - In my area postcode searches." />
...
<!-- ########################## -->
	...
	<div class="content_box">
		<h2>Up My Street</h2>
		<p><img src="<?php print getStaticContentRootURL(); ?>/site/images/ums_logo.gif" alt="Up My Street logo" class="contentimage" /><a href="http://www.upmystreet.com/enter-location/l/?fpage=%2Ffindmynearest%2F">FindMyNearest...&trade;</a> is the quick and easy way to find a local business.</p>
		...
		<form action="http://www.upmystreet.com/l/IV3.html" method="get" class="basic_form">
			<p>
				...
				<input type="text" value="<?php print encodeHtml($userPostcode); ?>" name="l1" id="l1" maxlength="20" class="field" /> <input type="submit" name="locSubmit" id="locSubmit" value="Go" class="button"/>
			</p>
		</form>
	</div>
	...
	<div class="content_box">
		<h2>Land registry</h2>
		<p><img src="<?php print getStaticContentRootURL(); ?>/site/images/lr_logo.gif" alt="Land Registry - Land Register Online" class="contentimage" />Download a plan for the house you&rsquo;re buying (only &pound;2).</p>
		...
		<form action="http://www.landregisteronline.gov.uk/lro/servlet/MultipleResultsServlet" method="get" class="basic_form">
			...
			<p>
				...
				<input id="postcode" type="text" name="postcode" value="<?php print encodeHtml($userPostcode); ?>" maxlength="20" class="field" /> <input type="submit" value="Go" class="button" />
			</p>
		</form>
	</div>
	...
	<div class="content_box">
		...
		<p><img src="<?php print getStaticContentRootURL(); ?>/site/images/ns_logo.gif" alt="National statistics" class="contentimage" />Interested or involved in neighbourhood regeneration and looking for statistics on topics such as employment or crime?</p>
		...
		<form action="http://neighbourhood.statistics.gov.uk/dissemination/NeighbourhoodProfileSearch.do" method="get" class="basic_form">
			<p>
				...
				<input type="text" value="<?php print encodeHtml($userPostcode); ?>" name="profileSearch" id="profileFocus" maxlength="20" class="field" />
	...
	<div class="content_box">
		...
		<p><img src="<?php print getStaticContentRootURL(); ?>/site/images/portcullis_black.gif" alt="Commons" class="contentimage" />Enter a complete postcode to find out which constituency you are in and who your Member of Parliament is.</p>
		<form action="http://www.locata.co.uk/cgi-bin/phpdriver" method="get" class="basic_form">
			...
			<p>
				...
				<input id="postcodeTwo" type="text" name="postcode" value="<?php print encodeHtml($userPostcode); ?>" maxlength="20" class="field" />
				<input type="submit" value="Go" class="button" />
			</p>
		</form>
	</div>
	...
	<div class="content_box">
		...
		<form action="<?php print getSiteRootURL(); ?>/site/scripts/whos_my_councillor.php" method="get" class="basic_form">
			<p>
				<label for="YourPostcode">Postcode</label>
				<input id="YourPostcode" type="text" name="postcode" value="<?php print encodeHtml($userPostcode); ?>" maxlength="20" class="field" />
	...
	<div class="content_box">
		<h2>BBC Weather</h2>
		<p><img src="<?php print getStaticContentRootURL(); ?>/site/images/bbc_weather_logo.gif" alt="BBC Weather" class="contentimage" />Enter a town, city, country name, or a UK postcode.</p>
		...
		<form action="http://www.bbc.co.uk/cgi-perl/weather/search/new_search.pl" method="get" class="basic_form">
			<p>
				...
				<input name="search_query" id="search_query" value="<?php print encodeHtml($userPostcode); ?>" maxlength="20" class="field" />
				<input type="submit" value="Go" class="button" />
			</p>
		</form>
	</div>
