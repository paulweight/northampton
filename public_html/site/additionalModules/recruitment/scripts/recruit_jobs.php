...
?>		
			<div class="cate_wrap">
				<div class="h_3"><?php print $jobCategory->title; ?></div>
				
<?php
				foreach ($jobs as $job) {
				$job->title = htmlentities($job->title);
?>
					<p><a href="recruit_details.php?id=<?php print $job->id; ?>"><?php print $job->title; ?></a> - Closing date: <?php print date("d F Y", $job->closingDate); ?></p>							
<?php
				}
?>
			</div>
