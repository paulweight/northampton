...
i="prev"===b.dir?0!=g:-g<100*(f.length-1),f=100*-(f.length-1);$target=c('[href="#'+this.id+'"]');if(!e.is(":animated")&&i)switch(g="prev"===b.dir?0!=g%100?h.roundDown(g):g+100:0!=g%100?h.roundDown(g)-100:g-100,e.trigger("carouselmove",{moveTo:g}),$target.removeClass(a.namespace+"-disabled").removeAttr("aria-disabled"),g){case f:$target.filter(a.nextSlide).addClass(a.namespace+"-disabled").attr("aria-disabled",!0);break;case 0:$target.filter(a.prevSlide).addClass(a.namespace+"-disabled").attr("aria-disabled",
!0)}else g=a.rotate&&"next"===b.dir?0:a.rotate&&"prev"===b.dir?f:h.roundDown(g),e.trigger("carouselmove",{moveTo:g})}};h.init(this);c(a.nextSlide+","+a.prevSlide).bind("click",function(d){var b=c(this),e=this.hash,g=b.is(a.prevSlide)?"prev":"next",e=c(e);if(b.is("."+a.namespace+"-disabled"))return!1;e.trigger("nextprev",{dir:g});d.preventDefault()}).bind("keydown",function(a){c(this);var b=this.hash;switch(a.which){case 37:case 38:c("#"+b).trigger("nextprev",{dir:"next"});a.preventDefault();break;
case 39:case 40:c("#"+b).trigger("nextprev",{dir:"prev"}),a.preventDefault()}});i.bind("dragSnap",{wrap:this,slider:a.slider},function(d,b){c(this).find(a.slider).trigger("nextprev",{dir:"left"===b.direction?"next":"prev"})});i.filter("[data-autorotate]").each(function(){var d,b=c(this),e=b.attr("data-autorotate"),g=b.find(a.slide).length,f=b.find(a.slider),h=function(){clearInterval(d);d=setInterval(function(){i();f.trigger("nextprev",{dir:"next"})},e)},i=function(){if(a.rotate)h();else switch(-(c(a.slider).getPercentage()/
