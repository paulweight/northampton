...
nextSlide:null,slideHed:null,addPagination:!1,addNav:k!=l&&(k.prevSlide||k.nextSlide)?!1:!0,namespace:"carousel",speed:300,rotate:!1,startSlide:1,lazy:!1,lazyFadeDuration:300},k),i=this,g=document.body||document.documentElement,f=!1,j={init:function(){m++;i.each(function(d){var e=b(this),c=e.find(a.slider),h=e.find(a.slide),o=h.length,n="margin-left "+a.speed/1E3+"s ease",f="carousel-"+m+"-"+d,g=1>a.startSlide?1:a.startSlide>o?o:parseInt(a.startSlide);1>=h.length||(e.css({overflow:"hidden",width:"100%"}).attr("role",
...
h=b("#"+h),h.parent().addClass(a.namespace+"-active-tab").siblings().removeClass(a.namespace+"-active-tab").find("a").attr({"aria-selected":!1,tabindex:-1}),h.attr({"aria-selected":!0,tabindex:0}))},move:function(d,e){var c=b(this);c.trigger(a.namespace+"-beforemove").trigger("navstate",{current:e.moveTo});c.trigger("loadimages");g.setAttribute("style","transition:top 1s ease;-webkit-transition:top 1s ease;-moz-transition:top 1s ease;");if(g.style.transition||g.style.webkitTransition||g.style.msTransition||
