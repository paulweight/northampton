...
<!-- ########################## -->
		...
		<p class="first">Contact <?php print METADATA_GENERIC_COUNCIL_NAME;?> directly using the <a href="http://<?php print $DOMAIN;?>/site/scripts/xforms_form.php?formID=18">feedback form</a> or alternatively, you can contact us using the details below.</p>
