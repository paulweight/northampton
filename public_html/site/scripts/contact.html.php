...
<!-- ########################## -->
	...
	<p>Contact the team directly using the <a href="<?php print getSiteRootURL() . buildFeedbackURL(); ?>">feedback form</a> or alternatively, you can contact us using the details below.</p>
...
?>
	<p>Visiting us? <a href="<?php print getSiteRootURL() . buildLocationURL();?>">Location map and travel details</a>.</p>
...
?>	              
<div<?php if (mb_strlen($contact->name) > 0) { print ' id="hcard-'. str_replace(' ', '-', encodeHtml($contact->name)) . '"'; } ?> class="vcard">
<?php 
