...
<div id="preview_box" class="plain_box"
<?php
	if (isset($_POST["previewButton"])) {
?>
...
>
	...
	<img src="http://<?php print $DOMAIN; ?>/site/images/cute.gif" alt="" class="contentimage" />	
	<p class="first" style="color: <?php print $fontColour; ?>;">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Etiam vestibulum velit eu nunc. <a style="color:<?php print $linkColour; ?>;" href="http://<?php print $DOMAIN; ?>" title="test link" >Nullam adipiscing</a> condimentum augue. </p>
	...
	<p style="color: <?php print $fontColour; ?>;"><a style="color:<?php print $linkColour; ?>;" href="http://<?php print $DOMAIN; ?>" title="test link" >Vivamus quam nunc</a>, consequat quis, volutpat non, venenatis sed, nisi. In pede. Cras ut nulla. Etiam scelerisque, est at aliquet suscipit, augue ipsum euismod justo, vitae pellentesque nulla erat nec tellus. Sed a dui sit amet pede tempor semper. In hac habitasse platea dictumst.</p>
</div>
