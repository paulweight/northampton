		...
		<ul class="slider" id="sliderName">
			...
			<li class="slide">	
				<div class="crop">
					...
					?>
					<a href="<?php print htmlspecialchars($advert->url);?>">
						<img alt="<?php print encodeHtml($advert->title);?>" src="http://<?php print DOMAIN; ?>/images/<?php print encodeHtml($advert->imageURL);?>" />
					</a>
					<?php
						}
					?>
					<div class="copy">
					<h2><a href="<?php print htmlspecialchars($advert->url);?>"><?php print encodeHtml($advert->title);?></a></h2>
					<?php
						if ($advert->subtitle) {
					?>
